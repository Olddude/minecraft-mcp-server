...
function createDistDirectory() {
    const backendOutputDirectory = join(workDir, 'dist/libs/core');
...
function publishPackageJson() {
    ...
    const backendPackageJson = {
        ...packageJsonOutput,
        name: `${packageJsonOutput.name}-lib-core`,
        main: 'index.js',
        bin: {
            'minecraft-mcp-lib-core': 'index.js',
        },
 ...
 */
function copyDocs() {
    const backendDocsDir = join(workDir, 'dist/libs/core/docs');
...
function copyOpenApiSpec() {
    const backendOutputDirectory = join(workDir, 'dist/libs/logging');
...
function buildApplication() {
    ...
    esbuild.build({
        entryPoints: ['libs/core/index.ts'],
        bundle: true,
        platform: 'node',
        target: 'node20',
        format: 'cjs',
        ...
        logLevel: 'info',
        metafile: true,
        tsconfig: 'libs/logging/tsconfig.app.json',
        plugins: [{
